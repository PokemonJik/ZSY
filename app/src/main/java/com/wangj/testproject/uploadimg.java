...
//        imageView= (ImageView) findViewById(R.id.imageView);
        ...
        findViewById(R.id.button).setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(uploadimg.this,grxx.class);
    ...
    private void openCamera() {
        ...
        if (Build.VERSION.SDK_INT < Build.VERSION_CODES.N) {
            ...
            imageUri = FileProvider.getUriForFile(uploadimg.this, "com.wangj.testproject.fileprovider", cameraFile);
...
//                        imageView.setImageBitmap(bitmap);
    ...
    private void sendImage(Bitmap bm)
    {
        ...
        Map<String,String>user = getuser_mes(uploadimg.this);
...
//        params.add(new BasicNameValuePair("name",name));
        //设置接收图片服务的地址和路径:
        client.post("http://" + ServerIp + "/ImgUpload.php", params, new AsyncHttpResponseHandler() {
            @Override
            public void onSuccess(int i, org.apache.http.Header[] headers, byte[] bytes) {
                Toast.makeText(uploadimg.this, "上传成功!", Toast.LENGTH_LONG).show();
            ...
            public void onFailure(int i, org.apache.http.Header[] headers, byte[] bytes, Throwable throwable) {
                Toast.makeText(uploadimg.this, "上传失败！", Toast.LENGTH_LONG).show();
            }
        });
    }
...
//        displayImage(imagePath); // 根据图片路径显示图片
    ...
    public void requestRuntimePermission(String[] permissions, PermissionListener listener) {
        ...
        for (String permission : permissions) {
            if (ContextCompat.checkSelfPermission(uploadimg.this, permission) != PackageManager.PERMISSION_GRANTED) {
                permissionList.add(permission);
            }
        }
        if (!permissionList.isEmpty()) {
            ActivityCompat.requestPermissions(uploadimg.this, permissionList.toArray(new String[permissionList.size()]), 1);
        } else {
            mListener.onGranted();
        }
    }
